...
def auth_json_path():
    """Return the Hexbot auth store path, respecting HERMES_HOME overrides."""
...
def peek_nous_access_token() -> Optional[str]:
    ...
    Availability scans (`hexbot core tools`, banner/status paint, provider
...
# managed vendor's gateway URL is pinned: adding one is a Hexbot release, and
