...
Storage
-------
Bundles live in ``~/.hexbot/skill-bundles/*.yaml`` (and the equivalent
...
- :func:`list_bundles` — return rich info for display (``hexbot core bundles``)
...
# ---------------------------------------------------------------------------
# File-level CRUD helpers — used by `hexbot core bundles` CLI subcommand.
# ---------------------------------------------------------------------------
