...
Optional hooks (override to opt in):
  ...
  backup_paths() -> list[str]            — extra on-disk paths to include in `hexbot core backup`
"""
...
class MemoryProvider(ABC):
    ...
    def initialize(self, session_id: str, **kwargs) -> None:
        ...
        kwargs always include:
          - hermes_home (str): The active HERMES_HOME directory path. Use this
            for profile-scoped storage instead of hardcoding ``~/.hexbot``.
    ...
    def get_config_schema(self) -> List[Dict[str, Any]]:
        ...
        Used by 'hexbot core memory setup' to walk the user through configuration.
    ...
    def save_config(self, values: Dict[str, Any], hermes_home: str) -> None:
        ...
        Called by 'hexbot core memory setup' after collecting user inputs.
    ...
    def backup_paths(self) -> List[str]:
        ...
        ``hexbot core backup`` only walks HERMES_HOME, so any provider state kept
        ...
        of the archive, and ``hexbot core import`` restores them to their original
