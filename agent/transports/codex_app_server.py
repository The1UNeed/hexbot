...
projection into Hexbot's display, approval bridging, transcript projection into
...
"codex_app_server"`. Hexbot's default tool dispatch is unchanged when this
...
class CodexAppServerClient:
    ...
    def __init__(
        ...
        # `os.environ.copy()` also handed it every Tier-1 Hexbot secret — gateway
