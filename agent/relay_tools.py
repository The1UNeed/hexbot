"""Core NeMo Relay adapter for Hexbot tool execution."""
    ...
    try:
        ...
        if (
            ...
            logger.warning(
                ...
                "returning the Hexbot tool result",
                exc_info=True,
            )
...
def _run_awaitable(value: Any) -> Any:
    ...
    raise RuntimeError(
        "Synchronous Hexbot Relay tool execution cannot run on an active event-loop thread"
    )
