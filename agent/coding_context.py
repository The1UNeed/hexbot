"""Coding-context awareness — base Hexbot, every interactive surface.

When the user runs Hexbot inside a code workspace (CLI, TUI, desktop app, or an
editor over ACP), Hexbot shifts into a **coding posture**. This module is the
...
def is_coding_context(
    *,
    ...
    """Whether Hexbot should operate in its coding posture right now."""
