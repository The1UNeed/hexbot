...
Hexbot (see website/docs/getting-started/platform-support.md). The
...
Hexbot package derivation, so only that build may create an artifact.
...
_BLOCK_MESSAGE = (
    ...
    "Hexbot is distributed via the shell installer, Docker image, or Nix.\n"
    ...
    "the Hexbot Nix derivation sets HERMES_NIX_BUILD=1. If it does, file a bug."
)
