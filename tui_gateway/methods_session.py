...
def _(rid, params: dict) -> dict:
    ...
    # ``hexbot core --tui`` session legitimately rides the real stdio transport and
    # must stay visible.
...
def _(rid, params: dict) -> dict:
    ...
    transfer is performed by the separate ``hexbot core gateway`` process, whose
...
def _(rid, params: dict) -> dict:
    ...
    agent = session["agent"]
    # Mirror the classic CLI /save: snapshot under the Hexbot profile home
    # (~/.hexbot/sessions/saved/) rather than the project/workspace CWD, and
