...
This is an additive Hexbot extension surfaced under ACP ``_meta.hermes`` so
...
compression rotates the internal Hexbot head, ``build_session_provenance`` lets
...
def build_session_provenance(
    ...
    *,
    ...
    Args:
        ...
        current_hermes_session_id: The live internal Hexbot DB session id
