"""
Cron job scheduling system for Hexbot.
...
Cron jobs are executed automatically by the gateway daemon:
    hexbot core gateway install    # Install as a user service
    sudo hexbot core gateway install --system  # Linux servers: boot-time system service
    hexbot core gateway            # Or run in foreground
