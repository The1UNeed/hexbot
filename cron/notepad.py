...
Write path is the CLI (``hexbot core cron notepad <job_id> set <key> <value>``),
...
def render_notepad_section(job_id: str) -> str:
    ...
    return (
        ...
        f"`hexbot core cron notepad {job_id} set <key> <value>` "
        f"(also: get/delete/list; `hexbot core cron notepad {job_id} delete "
