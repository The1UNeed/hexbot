...
# When the user hasn't picked a reasoning effort, Hexbot passes
...
# ON at this effort — matching the "medium (default)" that Hexbot's /reasoning
...
class UpstageProfile(ProviderProfile):
    ...
    def build_api_kwargs_extras(
        ...
        # Map Hexbot's effort vocabulary onto Solar's accepted set via the
