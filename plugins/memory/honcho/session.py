...
def _auth_error_message(exc: BaseException) -> str:
    return (
        ...
        "Re-authenticate with 'hexbot core honcho setup'."
    )
...
class HonchoSessionManager:
    ...
    def dialectic_query(
        ...
        try:
            ...
            # Only automatic injection uses the Hexbot-side character cap.
            if (
                apply_injection_cap
                and result
    ...
    def get_prefetch_context(self, session_key: str, user_message: str | None = None) -> dict[str, str]:
        ...
        # Also fetch AI peer's own representation so Hexbot knows itself.
        try:
    ...
    def migrate_memory_files(self, session_key: str, memory_dir: str) -> bool:
        ...
        Args:
            ...
            memory_dir: Path to the memories directory (~/.hexbot/memories/).
