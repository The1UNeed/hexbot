"""
A2A (Agent-to-Agent) plugin for Hexbot.

Registers:
  - The ``a2a`` platform adapter (inbound: exposes Hexbot as an A2A agent,
    protocol v1.0).
...
def interactive_setup() -> None:
    """`hexbot core gateway setup` flow for A2A."""
    ...
    print_info("Expose Hexbot as an A2A-discoverable agent and call other A2A agents.")
