/**
 * Hexbot desktop plugin template. Save as:
 *   <hexbot home>/desktop-plugins/<id>/plugin.js   (folder name == id)
 * where <hexbot home> is ~/.hexbot by default, or ~/.hexbot/profiles/<name>
 * when running a named profile (`hexbot core -p <name>`). Run `hexbot core doctor` (or
