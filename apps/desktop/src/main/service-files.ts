...
// HEXBOT_NODE is this app's Electron binary, which runs the Hex Connect sidecar as Node (hexbot/connect.py).
...
<plist version="1.0"><dict>
  ...
  <key>EnvironmentVariables</key><dict><key>HEXBOT_HOME</key><string>${xml(options.home)}</string><key>HEXBOT_SUPERVISOR</key><string>service</string><key>PATH</key><string>${xml(options.path)}</string><key>HEXBOT_NODE</key><string>${xml(options.node)}</string></dict>
