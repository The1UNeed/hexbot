...
export async function POST(request: Request) {
  ...
  if (pkceChallenge(body.code_verifier) !== row.challenge || body.redirect_uri !== row.redirectUri) return jsonError("invalid_request", "The sign-in code does not match this request", 400);
