...
export const en: Translations = {
  ...
  status: {
    ...
    stopped: "Stopped",
    updateHermes: "Update Hexbot",
    updateHermesConfirmMessage:
      "This runs hexbot core update and restarts the gateway when it finishes. Active sessions keep their prompt cache until then.",
    updateHermesConfirmNow: "Update now",
    updateHermesConfirmTitle: "Update Hexbot?",
    updatingHermes: "Updating Hexbot…",
  ...
  pluginsPage: {
    ...
    headline:
      "Discover, install, enable, and update Hexbot plugins (`hexbot core plugins` parity).",
    ...
    removeConfirm: "Remove this plugin from ~/.hexbot/plugins/?",
    removeHint: "Only user-installed plugins under ~/.hexbot/plugins can be removed.",
  ...
  skills: {
    ...
    filters: "Filters",
    noSkills: "No skills found. Skills are loaded from ~/.hexbot/skills/",
  ...
  env: {
    ...
    customHint: "Arbitrary environment variables stored in your .env that Hexbot doesn't recognise. Use these to inject env vars for skills, MCP servers, or your own tooling.",
  ...
  achievements: {
    hero: {
      ...
      subtitle:
        "Collectible Hexbot badges earned from real session history. Known unfinished achievements are shown as Discovered; Secret achievements stay hidden until the first matching behavior appears.",
      scan_subtitle:
        "Scanning Hexbot session history. First scan can take 5–10 seconds on large histories.",
    },
    actions: {
      rescan: "Rescan",
    },
    stats: {
      ...
      latest: "Latest",
      latest_hint_empty: "run Hexbot more",
      none_yet: "None yet",
    },
    state: {
      unlocked: "Unlocked",
    ...
    guide: {
      ...
      secret_body:
        "Secrets hide their exact trigger. Once Hexbot sees a related signal, the card becomes Discovered and shows its requirement.",
      scan_status_header: "Scan status",
      scan_status_body:
        "Hexbot is scanning local history once, then cards will appear automatically. Nothing is stuck if this takes a few seconds.",
