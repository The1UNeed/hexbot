...
`hexbot core kanban …`) inherit the same board the in-process kanban tools resolve.
Without this, a concurrent `hexbot core kanban boards switch` from another session
