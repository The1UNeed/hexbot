"""Tests for `hexbot core fallback` — chain reading, add/remove/clear, legacy migration."""
...
class TestListCommand:
    def test_list_empty(self, isolated_home, capsys):
        ...
        assert "hexbot core fallback add" in out
...
class TestArgparseWiring:
    """Verify `hexbot core fallback` is wired into main.py's argparse tree.
