...
The notice prints the most recent curator run summary on `hexbot core update`,
...
session start) so users normally never see the rename map. `hexbot core update`
