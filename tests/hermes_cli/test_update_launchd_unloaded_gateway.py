"""Regression for #74973 — `hexbot core update` must not leave the gateway down.
...
cron stayed dark until someone manually ran ``hexbot core gateway restart``.
...
class TestLaunchdRestartAfterUpdate:
    ...
    def test_restart_failure_warns_that_gateway_is_down(self, launchd, capsys):
        ...
        assert "hexbot core gateway restart" in out
