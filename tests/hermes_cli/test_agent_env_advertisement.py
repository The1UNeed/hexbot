...
Hexbot-specific marker, without clobbering an outer harness.

The AI_AGENT value must equal Hexbot's id in the public agent-harness
...
environment does not inherit the Hexbot process env, and survives the
