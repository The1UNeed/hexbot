...
Issue #98790: `hexbot core cron status` in profile B reports profile A's gateway
...
class TestCronStatusHeartbeatGuard:
    """Ensure `hexbot core cron status` correctly warns when the heartbeat file is absent.
