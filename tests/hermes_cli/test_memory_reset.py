"""Tests for the `hexbot core memory reset` CLI command.
...
def _run_memory_reset(target="all", yes=False, monkeypatch=None, confirm_input="no"):
    ...
    Simulates what happens when `hexbot core memory reset` is run.
    """
...
class TestMemoryReset:
    """Tests for `hexbot core memory reset` subcommand."""
