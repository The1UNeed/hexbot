...
tool registry nor a running Hexbot.
"""
...
# A representative set of real toolset names. `hexbot core` is deliberately absent —
# that is the corruption #38798 reported (`hermes-cli` rewritten to `hexbot core`).
_KNOWN = {
    "hermes-cli",
    "hermes-telegram",
    "hermes-discord",
