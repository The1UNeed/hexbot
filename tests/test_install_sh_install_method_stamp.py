...
gateway as well (``~/.hexbot:/opt/data``). The published image stamps 'docker'
...
``~/.hexbot/hermes-agent``), which is unique to this install and immune to the
shared data dir.
"""
