...
class TestDMTopicFallbackReplyToMode:
    ...
    reply_to_mode 'off' was ignored when sending via Hexbot-created DM topic
...
class TestDMTopicSyntheticSendRouting:
    ...
    response in a different chat lane than the Hexbot topic the session runs
    in. The no-anchor branch must prefer the Hexbot topic's
