...
Running a state-writing ``hexbot core cron`` CLI command as root (the default for
...
2. Zombie-ticker surfacing: a failing tick must persist the failure reason
   (``ticker_last_error``) where ``hexbot core cron status`` can show it, and a
...
# =========================================================================
# 3. `hexbot core cron status` surfaces the failure reason
# =========================================================================
