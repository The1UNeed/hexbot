...
Run from the PR worktree:
    ...
    cd ~/.hexbot/hermes-agent/.worktrees/browser-providers-plugin
...
# checkout lives two levels up at ``~/.hexbot/hermes-agent``.
MAIN_DIR = REPO_ROOT.parent.parent  # ~/.hexbot/hermes-agent
