...
def test_kanban_tools_hidden_without_env_var(monkeypatch, tmp_path):
    """Normal `hexbot core chat` sessions (no HERMES_KANBAN_TASK) must have
...
# restarting Hexbot. These tests pin that ``board=<slug>`` argument
...
def multi_board_env(monkeypatch, tmp_path):
    """Isolated Hexbot home with two distinct kanban boards seeded.
