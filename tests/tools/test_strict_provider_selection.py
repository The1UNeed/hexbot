"""Strict tool-provider selection: the `hexbot core tools` choice always wins.
...
selection and pointing at `hexbot core tools`.
...
class TestImageFalStrictSelection:
    ...
    def test_nous_selection_unentitled_raises_selection_error(self):
        ...
        assert "hexbot core tools" in str(exc.value)
