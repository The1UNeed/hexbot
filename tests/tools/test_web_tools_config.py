...
class TestBackendSelection:
    ...
    ``hexbot core tools``.  Falls back to key-based detection for legacy/manual
    setups.
    """
...
class TestFirecrawlEnvResolution:
    ...
    values stored in ~/.hexbot/.env were invisible to the provider."""
...
class TestSiblingProvidersEnvResolution:
    ...
    ~/.hexbot/.env), not bare os.getenv. Parametrized over the four
