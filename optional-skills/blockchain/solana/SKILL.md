...
Helper script path: ~/.hexbot/skills/blockchain/solana/scripts/solana_client.py
...
python ~/.hexbot/skills/blockchain/solana/scripts/solana_client.py stats
```
...
```bash
python ~/.hexbot/skills/blockchain/solana/scripts/solana_client.py \
...
```bash
python ~/.hexbot/skills/blockchain/solana/scripts/solana_client.py price BONK
python ~/.hexbot/skills/blockchain/solana/scripts/solana_client.py price JUP
python ~/.hexbot/skills/blockchain/solana/scripts/solana_client.py price SOL
python ~/.hexbot/skills/blockchain/solana/scripts/solana_client.py price DezXAZ8z7PnrnRJjz3wXBoRgixCa6xjnB7YaB1pPB263
```
