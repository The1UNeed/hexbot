...
The script reads `${HERMES_HOME:-~/.hexbot}/.env` for two optional defaults:
...
Helper script: `~/.hexbot/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py`
...
```bash
python ~/.hexbot/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py <command> [args]
```
...
optional when `HYPERLIQUID_USER_ADDRESS` is set in `${HERMES_HOME:-~/.hexbot}/.env`.
...
```bash
python ~/.hexbot/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py dexs

python ~/.hexbot/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py \
