...
Helper script path: `~/.hexbot/skills/blockchain/evm/scripts/evm_client.py`
...
```
SCRIPT=~/.hexbot/skills/blockchain/evm/scripts/evm_client.py
...
python ~/.hexbot/skills/blockchain/evm/scripts/evm_client.py stats
```
...
python ~/.hexbot/skills/blockchain/evm/scripts/evm_client.py ens vitalik.eth
```
