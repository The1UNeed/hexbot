...
import sys
import os
sys.path.insert(0, os.path.expanduser("~/.hexbot/skills/creative/pixel-art/scripts"))
...
```bash
cd ~/.hexbot/skills/creative/pixel-art/scripts
...
- ffmpeg on PATH (only needed for video — Hexbot installs package this)
