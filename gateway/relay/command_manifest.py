...
def build_relay_command_manifest() -> List[Dict[str, Any]]:
    ...
    return [
        ...
        {"name": "reset", "description": "Reset your Hexbot session"},
        {
            "name": "model",
        ...
        {"name": "status", "description": "Show Hexbot session status"},
        {"name": "sethome", "description": "Set this chat as the home channel"},
        {"name": "stop", "description": "Stop the running Hexbot agent"},
        {
            "name": "steer",
        ...
        {"name": "update", "description": "Update Hexbot to the latest version"},
        {"name": "restart", "description": "Gracefully restart the Hexbot gateway"},
        {
            "name": "approve",
        ...
        {
            "name": "thread",
            "description": "Create a new thread and start a Hexbot session in it",
