...
Hexbot's long-running gateway status surface into short status lines suitable
for chat surfaces.
...
# These are Hexbot UI surfaces, not app/vendor/domain buckets.  Keep this
...
def classify_status_context(
    ...
    *,
    ...
    """Classify an internal gateway event into a Hexbot UI-surface bucket."""
