"""Relay subscriber for the persisted Hexbot shared-metrics slice."""
...
class SharedMetricsSubscriber:
    """Persist validated Hexbot counters from Relay lifecycle events."""
    ...
    def __call__(self, event: Any) -> None:
        ...
        with self._lock:
            ...
            try:
                ...
                logger.warning(
                    "Unable to persist the Hexbot shared metric: %s",
                    metric_name,
                    exc_info=True,
                )
