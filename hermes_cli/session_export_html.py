"""
HTML Export generator for Hexbot sessions.
...
<body>
    <div class="layout {layout_class}">
        ...
        <div class="main-content">
            ...
            <footer>
                Built with ☤ Hexbot • Generated on {generated_at}
            </footer>
        </div>
    </div>
...
def generate_multi_session_html_export(sessions: List[Dict[str, Any]]) -> str:
    ...
    for s in sessions:
        sid = str(s.get("id", "N/A"))
        escaped_sid = _escape_html(sid)
        title = s.get("title") or "Hexbot Session"
    ...
    return HTML_TEMPLATE.format(
        page_title="Hexbot Session Export" if is_multi else _escape_html(sessions[0].get("title") or "Hexbot Session"),
