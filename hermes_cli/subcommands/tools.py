"""``hexbot core tools`` subcommand parser.
...
def build_tools_parser(subparsers, *, cmd_tools: Callable) -> None:
    ...
    tools_parser = subparsers.add_parser(
        ...
        description=(
            ...
            "Run 'hexbot core tools' with no subcommand for the interactive configuration UI."
        ),
    )
    ...
    # hexbot core tools list [--platform cli]
    ...
    # hexbot core tools disable <name...> [--platform cli]
    ...
    # hexbot core tools enable <name...> [--platform cli]
    ...
    # hexbot core tools post-setup <key>
    tools_postsetup_p = tools_sub.add_parser(
        ...
        description=(
            ...
            "same step `hexbot core tools` runs after you pick a provider that\n"
