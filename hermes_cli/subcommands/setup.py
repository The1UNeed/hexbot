"""``hexbot core setup`` subcommand parser.
...
def build_setup_parser(subparsers, *, cmd_setup: Callable) -> None:
    ...
    setup_parser = subparsers.add_parser(
        ...
        description="Configure Hexbot with an interactive wizard. "
        "Run a specific section: "
        "hexbot core setup model|tts|terminal|gateway|tools|telemetry|agent",
    )
    ...
    setup_parser.add_argument(
        ...
        "compatibility — a bare 'hexbot core setup' now does this.",
    )
    setup_parser.add_argument(
        "--quick",
        action="store_true",
