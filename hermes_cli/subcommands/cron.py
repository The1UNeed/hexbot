"""``hexbot core cron`` subcommand parser.
...
def build_cron_parser(subparsers, *, cmd_cron: Callable) -> None:
    ...
    cron_create.add_argument(
        "--script",
        help=(
            "Path to a script under ~/.hexbot/scripts/. Default mode: "
    ...
    cron_create.add_argument(
        ...
        help=(
            ...
            "~/.hexbot/scripts/ that runs each tick BEFORE the agent. "
    ...
    cron_edit.add_argument(
        "--script",
        help=(
            "Path to a script under ~/.hexbot/scripts/. Pass empty string to clear. "
    ...
    cron_edit.add_argument(
        ...
        dest="monitor_script",
        help=(
            "Set/replace the monitor source script (see `hexbot core cron create "
